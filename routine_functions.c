...
/*   Updated: 2025/09/05 16:23:30 by hgatarek         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void philo_eating(t_philo *philo)
{
	...
	print_status(philo->philo_id, "picks up left fork");
	pthread_mutex_lock(philo->right_fork);
	print_status(philo->philo_id, "picks up right fork");
	pthread_mutex_lock(&philo->philo_mutex);
	print_status(philo->philo_id, "is eating");
...
void philo_sleeping(t_philo *philo)
{
	...
	print_status(philo->philo_id, "is sleeping");
	return ;
}

void philo_thinking(t_philo *philo)
{
	print_status(philo->philo_id, "is thinking");
	return ;
}